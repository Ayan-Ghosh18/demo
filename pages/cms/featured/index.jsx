...
import { useGetDoctorfeatured } from '@/hooks/customHooks/cmsQuery.hooks';
...
export default function index() {
    ...
    const { data, isLoading, isError } = useGetDoctorfeatured();
    if (isLoading) {
        return (
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
          loading Featured Doctors....  <CircularProgress />
          </Box>
        );
      }
    ...
    return (
        <>
            <div style={{ backgroundColor: "#0073e6", color: "white", padding: "15px 20px", textAlign: "center", fontSize: "40px",
                 fontWeight: "bolder", fontFamily: "cursive", marginTop: "20px", borderRadius: "5px", width: "100%",
