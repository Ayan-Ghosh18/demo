...
import { useGetpersonalcare } from '@/hooks/customHooks/cmsQuery.hooks';
...
export default function index() {
    ...
    const {data, isError, isLoading} = useGetpersonalcare();
    if (isLoading) {
      return (
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
        loading Personal Care doctors....  <CircularProgress />
        </Box>
      );
    }
